 ...
 * @Description: 登录
 */
public class MoreActivity extends BaseActivity implements OnClickListener,IWXAPIEventHandler,IUiListener{
	...
	public void onClick(View v) {
		...
		case R.id.rl_account_setting:
			if(!pref.getString(Constant.PHONE, "").equals("")){
				intent.setClass(MoreActivity.this, AccountSettingActivity.class);
			}else{
				intent.setClass(MoreActivity.this, BindingPhoneActivity.class);
			}
		...
		case R.id.rl_promotion_strategy:
			intent.setClass(MoreActivity.this, StrategyActivity.class);
			startActivity(intent);
			break;
		case R.id.rl_wave:
			intent.setClass(MoreActivity.this, WaveActivity.class);
			startActivity(intent);
			break;
		case R.id.rl_system_notice:
			intent.setClass(MoreActivity.this, SysNoticeActivity.class);
			startActivity(intent);
			break;
		...
		case R.id.btn_exit:
			...
			dialog = new CustomDialog(MoreActivity.this, R.style.CustomDialog, new CustomDialog.CustomDialogListener() {
				...
				public void onClick(View view) {
					...
					case R.id.btn_left:
						...
						OffersManager.getInstance(MoreActivity.this).onAppExit();
		...
		case R.id.rl_qr_code:
			mDialog = new CustomDialog(MoreActivity.this, R.style.CustomDialog, new CustomDialog.CustomDialogListener() {
		...
		case R.id.iv_lock_screen:
			intent = new Intent(MoreActivity.this, LockScreenService.class);
			if(!pref.getBoolean(Constant.IS_LOCK_SCREEN, false)){
				MobclickAgent.onEvent(MoreActivity.this, "startLockScreen");
				iv_lock_screen.setImageDrawable(getResources().getDrawable(R.drawable.radiobtn_on));
				tv_lock_screen.setText(getResources().getString(R.string.m_lock_screen_on));
				editor.putBoolean(Constant.IS_LOCK_SCREEN, true);
				editor.putInt(Constant.SLIDED, 0);
				editor.commit();
				MoreActivity.this.startService(intent); //这里要显示的调用服务
			}else{
				MobclickAgent.onEvent(MoreActivity.this, "closeLockScreen");
				iv_lock_screen.setImageDrawable(getResources().getDrawable(R.drawable.radiobtn_off));
				tv_lock_screen.setText(getResources().getString(R.string.m_lock_screen_off));
				editor.putBoolean(Constant.IS_LOCK_SCREEN, false);
				editor.commit();
				MoreActivity.this.stopService(intent); //关闭调用服务
			}
			break;
	 ...
	 */
	private void share(){
		sDialog = new CustomDialog(MoreActivity.this, R.style.CustomDialog, new CustomDialog.CustomDialogListener() {
			
			@Override
			public void onClick(View view) {
				switch (view.getId()) {
				case R.id.ll_share_wx:
					MoreActivity.this.wechatShare(1);
					break;
				case R.id.ll_share_wx_friends:
					MoreActivity.this.wechatShare(0);
					break;
	...
	public void doShareTencent()
    {
        ...
        MainActivity.mTencent.shareToQQ(MoreActivity.this, bundle , this);
